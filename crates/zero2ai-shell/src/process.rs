...
///
/// Defined in `zero2ai-builtins` alongside the process-table snapshots its process
/// builtins read, and re-exported here so this module — and `zero2ai-natives`
/// through it — keeps one status type for both concerns.
pub use zero2ai_builtins::ProcessStatus;
