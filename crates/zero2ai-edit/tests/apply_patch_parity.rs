...
fn partial_json_edit_entries_parity() {
	let complete = zero2ai_edit::stream_json::snapshot_from_text(
	...
	let trailing_open = zero2ai_edit::stream_json::snapshot_from_text(
		r#"{"path":"a","edits":[{"op":"delete"},{"op":"delete""#,
		false,
		false,
	);
	...
	let newly_opened = zero2ai_edit::stream_json::snapshot_from_text(
	...
	let empty = zero2ai_edit::stream_json::snapshot_from_text(r#"{"edits":["#, false, false);
