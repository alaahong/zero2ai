...
use zero2ai_ast::block::{EnclosingBoundaryOptions, LineRange, enclosing_block_boundaries};
use regex::Regex;
...
pub fn generate_diff_string(
	...
	let parts = zero2ai_diff::line_changes_str(old, new);
...
pub fn generate_unified_diff_string(
	...
	let hunks = zero2ai_diff::structured_patch_hunks_u16(
		&old_utf16,
		&new_utf16,
