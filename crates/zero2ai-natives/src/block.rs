...
impl From<zero2ai_ast::block::BlockRange> for BlockRange {
	fn from(value: zero2ai_ast::block::BlockRange) -> Self {
...
pub fn block_range_at(options: BlockRangeOptions) -> Result<Option<BlockRange>> {
	zero2ai_ast::block::block_range_at(zero2ai_ast::block::BlockRangeOptions {
		code: options.code,
		lang: options.lang,
		path: options.path,
		line: options.line,
...
impl From<zero2ai_ast::block::NodeSpan> for NodeSpan {
	fn from(value: zero2ai_ast::block::NodeSpan) -> Self {
...
pub fn node_chain_at(options: BlockRangeOptions) -> Result<Option<Vec<NodeSpan>>> {
	zero2ai_ast::block::node_chain_at(zero2ai_ast::block::BlockRangeOptions {
		code: options.code,
		lang: options.lang,
		path: options.path,
		line: options.line,
...
pub fn enclosing_block_boundaries(options: EnclosingBoundaryOptions) -> Result<Option<Vec<u32>>> {
	zero2ai_ast::block::enclosing_block_boundaries(zero2ai_ast::block::EnclosingBoundaryOptions {
		code:   options.code,
		lang:   options.lang,
		path:   options.path,
		ranges: options
			.ranges
			.into_iter()
			.map(|range| zero2ai_ast::block::LineRange {
