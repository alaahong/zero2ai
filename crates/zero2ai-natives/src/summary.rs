...
impl From<zero2ai_ast::summary::SummarySegment> for SummarySegment {
	fn from(value: zero2ai_ast::summary::SummarySegment) -> Self {
		Self {
			kind:       value.kind,
...
impl From<zero2ai_ast::summary::SummaryResult> for SummaryResult {
	fn from(value: zero2ai_ast::summary::SummaryResult) -> Self {
		Self {
...
pub fn summarize_code(options: SummaryOptions) -> Result<SummaryResult> {
	zero2ai_ast::summary::summarize_code(zero2ai_ast::summary::SummaryOptions {
		code:               options.code,
		lang:               options.lang,
		path:               options.path,
