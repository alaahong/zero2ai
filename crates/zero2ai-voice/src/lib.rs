...
//!
//! napi-free by design. `zero2ai-natives` wraps these types in thin `#[napi]`
...
//! # Architecture
//! ```text
//! JS (packages/natives) -> #[napi] adapters (zero2ai-natives audio.rs / live.rs)
//!   -> zero2ai_voice::audio  (capture/playback engine over in-house OS backends)
//!   -> zero2ai_voice::live   (WebRTC peer + Opus media, feeds audio playback)
//! ```
//!
