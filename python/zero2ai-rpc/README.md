...
Typed Python bindings for the `zero2ai --mode rpc` protocol used by the coding agent.
...
- typed startup options for common `zero2ai --mode rpc` flags such as thinking level,
...
```python
from zero2ai_rpc import MessageUpdateEvent, RpcClient
...
from zero2ai_rpc import RpcClient, host_tool
...
```python
from zero2ai_rpc import RpcClient, host_uri
...
```python
from zero2ai_rpc import assistant_text, assistant_text_with_thinking
