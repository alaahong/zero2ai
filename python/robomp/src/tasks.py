...
async def handle_release_ci(
    *,
    ...
    if row is None:
        session_dir = sandbox.workspace_root(repo_full, "release") / f".zero2ai-session-{tag}"
...
async def triage_issue(
    *,
    ...
    if existing is None:
        ...
        # resources (workspace, zero2ai session) to this issue.
        try:
...
async def handle_pr_conversation(
    *,
    ...
    # being present tells us a mention happened. Reply cheaply without zero2ai.
