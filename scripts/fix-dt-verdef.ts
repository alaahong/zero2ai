 ...
 * both of which zero2ai's nix fixup chain does — it relocates the dynamic-section
 ...
 * ELF64 little-endian only — the only shape zero2ai's Linux outputs take. Binaries
