...
# terminal transcript.
#
# Prepare a directory (default ~/zero2ai-signing) containing:
...
#   ZERO2AI_REPO=owner/repo scripts/ci-macos-upload-secrets.sh ~/zero2ai-signing
...
DIR="${DIR:-${ZERO2AI_SIGNING_DIR:-$HOME/zero2ai-signing}}"
REPO="${ZERO2AI_REPO:-can1357/oh-my-pi}"
