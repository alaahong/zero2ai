...
import {
	...
	type Tokens,
} from "@zero2ai/utils/marked";
import { mathBlockAt, mathSpanAt, mathStartIndex } from "@zero2ai/utils/math-delimiters";
...
// Delimiters come from `@zero2ai/utils/math-delimiters`; rendering policy stays here.
