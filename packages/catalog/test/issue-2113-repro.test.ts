/**
 * Issue #2113 — `kimik2 does not work on the latest zero2ai`
 *
...
import { type OpenAICompletionsOptions, streamOpenAICompletions } from "@zero2ai/ai/providers/openai-completions";
import type { AssistantMessage, Context } from "@zero2ai/ai/types";
import { buildModel } from "@zero2ai/catalog/build";
import { Effort } from "@zero2ai/catalog/effort";
import { getBundledModel } from "@zero2ai/catalog/models";
import { moonshotModelManagerOptions } from "@zero2ai/catalog/provider-models/openai-compat";
