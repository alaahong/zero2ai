...
import { toClinePassPublicModelId, toClinePassWireModelId } from "@zero2ai/catalog/cline-pass-model-id";
...
import { createReferenceResolver } from "@zero2ai/catalog/provider-models/bundled-references";
import { clinePassModelManagerOptions } from "@zero2ai/catalog/provider-models/openai-compat";
