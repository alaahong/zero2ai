/**
 * Shared chart primitives for the dashboard timeline charts: the ZERO2AI color
...
import { format } from "@zero2ai/utils/dates";

// ZERO2AI brand palette (packages/collab-web/src/styles/tokens.css): pink/purple/cyan.
