 ...
 * of the fixture JSONL — exactly the frames a real `zero2ai /collab` host emits.
 */

import type { AgentSnapshot, HostFrame, SessionEntry, SessionState, WireFrame } from "@zero2ai/wire";
