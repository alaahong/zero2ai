import type { MarkedExtension, Tokens } from "@zero2ai/utils/marked";
import { type MathSpan, mathBlockAt, mathSpanAt, mathStartIndex } from "@zero2ai/utils/math-delimiters";
 ...
 * scan hint come from `@zero2ai/utils/math-delimiters`, so this renderer and
