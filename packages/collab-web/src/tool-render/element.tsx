/**
 * `<zero2ai-tool-view>` — web-component wrapper around ToolView for non-React
...
export class Zero2AiToolViewElement extends HTMLElement {
	#root: Root | null = null;
...
export function defineToolViewElement(tag = "zero2ai-tool-view"): void {
	if (!customElements.get(tag)) customElements.define(tag, Zero2AiToolViewElement);
}
