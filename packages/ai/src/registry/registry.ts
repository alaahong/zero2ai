import type { KnownProvider } from "@zero2ai/catalog";
import { authProviders } from "@zero2ai/catalog/compat/auth";
import type { AuthProviderId, LoginProviderId } from "@zero2ai/catalog/compat/auth-ids";
 ...
 * (`@zero2ai/catalog` `rules/auth/*.kdl`) in `/login` display order.
