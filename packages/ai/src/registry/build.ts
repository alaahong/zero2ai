 ...
 * {@link ProviderDefinition} the rest of `@zero2ai/ai` consumes.
 */
import type { CompiledAuthProvider } from "@zero2ai/catalog/compat/types";
import { $pickenv } from "@zero2ai/utils";
