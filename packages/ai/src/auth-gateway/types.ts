...
/**
 * Wire types for the zero2ai auth-gateway.
 *
 * The gateway sits between unauthenticated clients (containerized zero2ai,
 ...
 * dispatches them through zero2ai-ai's `streamSimple()`, and translates the
