...
import type { AssistantMessage, Message, Model, UserMessage } from "@zero2ai/ai/types";
 ...
 *
 * Reproduces the shape captured in `~/.zero2ai/logs/http-400-requests/*.json` after Claude
