...
import { buildRequest } from "@zero2ai/ai/providers/google-gemini-cli";
import { convertTools } from "@zero2ai/ai/providers/google-shared";
import type { Context, Model, TJsonSchema, Tool } from "@zero2ai/ai/types";
import {
	enforceStrictSchema,
