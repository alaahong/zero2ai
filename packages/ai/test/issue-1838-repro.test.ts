 ...
 * `reasoning_content` even though zero2ai already sends it on the wire (the Kimi
...
import type { AssistantMessage, Context, FetchImpl, Model, ModelSpec } from "@zero2ai/ai/types";
