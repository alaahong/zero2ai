...
import type { ResponseCreateParamsStreaming } from "@zero2ai/ai/providers/openai-responses-wire";
import {
...
import type { Model, ModelSpec, OpenAICompat } from "@zero2ai/ai/types";
