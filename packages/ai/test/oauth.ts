/**
 * Test helper for resolving API keys from ~/.zero2ai/agent/testauth.db
 *
...
import { getOAuthApiKey } from "@zero2ai/ai/oauth";
import type { OAuthCredentials, OAuthProvider } from "@zero2ai/ai/oauth/types";
import { $flag, getAgentDir, isEnoent } from "@zero2ai/utils";
...
/**
 * Resolve API key for a provider from ~/.zero2ai/agent/testauth.db
 *
