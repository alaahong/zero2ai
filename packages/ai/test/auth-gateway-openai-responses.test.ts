...
import { encodeResponse, encodeStream, parseRequest } from "@zero2ai/ai/providers/openai-responses-server";
import { buildResponsesInput } from "@zero2ai/ai/providers/openai-shared";
import type { AssistantMessage, Context, ModelSpec } from "@zero2ai/ai/types";
...
describe("openai-responses parseRequest", () => {
	it("parses an input array with mixed message + reasoning + function_call + function_call_output", () => {
		...
		// plumbed through zero2ai-ai — they no longer leak into options.extra.
