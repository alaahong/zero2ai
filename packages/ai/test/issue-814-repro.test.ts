...
import type { AssistantMessage, Model, ModelSpec, ToolResultMessage, UserMessage } from "@zero2ai/ai/types";
 ...
 * carries `tool_use_id`. As a workaround, ZERO2AI must include `id` (aliased to
