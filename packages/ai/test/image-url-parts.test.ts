...
import { convertResponsesInputContent } from "@zero2ai/ai/providers/openai-shared";
import type { Context, FetchImpl, Message, Model, ProviderFileReference, UserMessage } from "@zero2ai/ai/types";
