...
import { loadCustomCommands } from "@zero2ai/coding-agent/extensibility/custom-commands/loader";
import { loadCustomTools } from "@zero2ai/coding-agent/extensibility/custom-tools/loader";
