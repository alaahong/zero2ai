...
import { applyExtensionFlags, type ExtensionFlagSink } from "@zero2ai/coding-agent/cli/extension-flags";
import { buildInitialMessage } from "@zero2ai/coding-agent/cli/initial-message";
...
import { normalizeContinueSessionArgs } from "@zero2ai/coding-agent/main";
