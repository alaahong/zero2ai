...
import { __computeBundledSelfPackageRoot } from "@zero2ai/coding-agent/extensibility/plugins/legacy-pi-compat";
...
// bundled host packages and shims through the `zero2ai-legacy-pi-bundled:`
...
describe("legacy pi compat bundled-self package root computation", () => {
	it("derives the npm prebuilt bundle package root from dist import.meta.dir", () => {
		...
		const posixMetaDir = "/home/me/.bun/install/global/node_modules/@zero2ai/coding-agent/dist";
		expect(__computeBundledSelfPackageRoot(posixMetaDir, path.posix)).toBe(
			"/home/me/.bun/install/global/node_modules/@zero2ai/coding-agent",
		);
	});

	it("derives the source package root when ZERO2AI_BUNDLED is used outside dist", () => {
