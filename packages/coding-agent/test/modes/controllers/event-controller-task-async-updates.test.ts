...
import type { TaskToolDetails } from "@zero2ai/coding-agent/task/types";
import type { BashToolDetails } from "@zero2ai/coding-agent/tools/bash";
import type { CoordinationDetails } from "@zero2ai/coding-agent/tools/hub";
