...
import { PluginSelectorComponent } from "@zero2ai/coding-agent/modes/components/plugin-selector";
import { QueueModeSelectorComponent } from "@zero2ai/coding-agent/modes/components/queue-mode-selector";
import { ThemeSelectorComponent } from "@zero2ai/coding-agent/modes/components/theme-selector";
import { ThinkingSelectorComponent } from "@zero2ai/coding-agent/modes/components/thinking-selector";
import { initTheme } from "@zero2ai/coding-agent/modes/theme/theme";
import type { SgrMouseEvent } from "@zero2ai/tui";
