...
import type { AssistantThinkingRenderer } from "@zero2ai/coding-agent/extensibility/extensions";
...
import { clearMermaidCache } from "@zero2ai/coding-agent/modes/theme/mermaid-cache";
import { initTheme } from "@zero2ai/coding-agent/modes/theme/theme";
import { ImageProtocol, setTerminalImageProtocol, TERMINAL, Text } from "@zero2ai/tui";
