...
import { createBackgroundTanDispatchBlock } from "@zero2ai/coding-agent/modes/components/background-tan-message";
import { initTheme } from "@zero2ai/coding-agent/modes/theme/theme";
import { BACKGROUND_TAN_DISPATCH_MESSAGE_TYPE, type CustomMessage } from "@zero2ai/coding-agent/session/messages";
