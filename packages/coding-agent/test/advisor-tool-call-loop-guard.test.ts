...
import { Agent, type AgentMessage, type AgentTool, type AgentTurnEndContext } from "@zero2ai/agent-core";
import type { AssistantMessage, Context, ToolResultMessage } from "@zero2ai/ai";
...
describe("advisor tool-call loop guard", () => {
	...
	beforeAll(() => {
		tempDir = TempDir.createSync("@zero2ai-advisor-tool-call-loop-guard-");
