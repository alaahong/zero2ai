...
import { runOnboardingSetup } from "@zero2ai/coding-agent/commands/setup";
...
import {
	...
	type SetupSceneHost,
	selectSetupScenes,
} from "@zero2ai/coding-agent/modes/setup-wizard";
import { providersSetupScene } from "@zero2ai/coding-agent/modes/setup-wizard/scenes/providers";
import { themeSetupScene } from "@zero2ai/coding-agent/modes/setup-wizard/scenes/theme";
import { WebSearchTab } from "@zero2ai/coding-agent/modes/setup-wizard/scenes/web-search";
import { SetupWizardComponent } from "@zero2ai/coding-agent/modes/setup-wizard/wizard-overlay";
...
import { SEARCH_PROVIDER_OPTIONS, SEARCH_PROVIDER_ORDER } from "@zero2ai/coding-agent/web/search/types";
...
describe("zero2ai setup onboarding trigger", () => {
