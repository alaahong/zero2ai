...
import { getRecentSessions } from "@zero2ai/coding-agent/session/session-listing";
import { SessionManager } from "@zero2ai/coding-agent/session/session-manager";
import { resetSessionTitleIndexForTests } from "@zero2ai/coding-agent/session/title-index";
...
describe("recent sessions title index", () => {
	...
	beforeEach(() => {
		testAgentDir = fs.mkdtempSync(path.join(os.tmpdir(), "zero2ai-recent-titles-"));
