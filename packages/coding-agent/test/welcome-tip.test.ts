...
import { renderWelcomeTip, WelcomeComponent } from "@zero2ai/coding-agent/modes/components/welcome";
import { initTheme, setSymbolPreset, setTheme, theme } from "@zero2ai/coding-agent/modes/theme/theme";
