...
import type { FileDiagnosticsResult } from "@zero2ai/coding-agent/lsp";
import { DiagnosticsLedger, diagnosticIdentity } from "@zero2ai/coding-agent/lsp/diagnostics-ledger";
