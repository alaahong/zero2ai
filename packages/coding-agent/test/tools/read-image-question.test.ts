...
import { type completeSimple, Effort, type ImageContent, type Model } from "@zero2ai/ai";
import { buildModel } from "@zero2ai/catalog/build";
import { Settings } from "@zero2ai/coding-agent/config/settings";
import type { ImageAttachmentEntry, ToolSession } from "@zero2ai/coding-agent/tools";
...
describe("read image questions", () => {
	...
	beforeAll(() => {
		testDir = fs.mkdtempSync(path.join(os.tmpdir(), "zero2ai-read-image-question-"));
