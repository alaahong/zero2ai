...
import { handleDevTo } from "@zero2ai/coding-agent/web/scrapers/devto";
import { handleGitLab } from "@zero2ai/coding-agent/web/scrapers/gitlab";
import { handleHackerNews } from "@zero2ai/coding-agent/web/scrapers/hackernews";
import { handleLobsters } from "@zero2ai/coding-agent/web/scrapers/lobsters";
