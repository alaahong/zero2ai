...
import { handleAur } from "@zero2ai/coding-agent/web/scrapers/aur";
import { handleBrew } from "@zero2ai/coding-agent/web/scrapers/brew";
import { handleMaven } from "@zero2ai/coding-agent/web/scrapers/maven";
import { handleNuGet } from "@zero2ai/coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@zero2ai/coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@zero2ai/coding-agent/web/scrapers/rubygems";
