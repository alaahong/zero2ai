...
import { handleCratesIo } from "@zero2ai/coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@zero2ai/coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@zero2ai/coding-agent/web/scrapers/hex";
import { handleNpm } from "@zero2ai/coding-agent/web/scrapers/npm";
import { handleOllama } from "@zero2ai/coding-agent/web/scrapers/ollama";
import { handlePubDev } from "@zero2ai/coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@zero2ai/coding-agent/web/scrapers/pypi";
