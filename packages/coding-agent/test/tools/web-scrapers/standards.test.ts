...
import { handleCheatSh } from "@zero2ai/coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@zero2ai/coding-agent/web/scrapers/rfc";
import { handleTldr } from "@zero2ai/coding-agent/web/scrapers/tldr";
