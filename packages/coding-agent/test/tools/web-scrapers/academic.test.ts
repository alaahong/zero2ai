...
import { handleArxiv } from "@zero2ai/coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@zero2ai/coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@zero2ai/coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@zero2ai/coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@zero2ai/coding-agent/web/scrapers/types";
