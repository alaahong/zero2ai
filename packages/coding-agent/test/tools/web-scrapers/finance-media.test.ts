...
import { handleArtifactHub } from "@zero2ai/coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@zero2ai/coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@zero2ai/coding-agent/web/scrapers/discogs";
