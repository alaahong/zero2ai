...
import { handleHuggingFace } from "@zero2ai/coding-agent/web/scrapers/huggingface";
import { handleSpotify } from "@zero2ai/coding-agent/web/scrapers/spotify";
import { handleVimeo } from "@zero2ai/coding-agent/web/scrapers/vimeo";
