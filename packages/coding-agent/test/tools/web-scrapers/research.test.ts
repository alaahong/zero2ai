...
import { handleBiorxiv } from "@zero2ai/coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@zero2ai/coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@zero2ai/coding-agent/web/scrapers/wikidata";
