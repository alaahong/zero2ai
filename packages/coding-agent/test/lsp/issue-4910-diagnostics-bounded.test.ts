...
import { getDiagnosticsForFile } from "@zero2ai/coding-agent/lsp/diagnostics";
import type { Diagnostic, LinterClient, ServerConfig } from "@zero2ai/coding-agent/lsp/types";
