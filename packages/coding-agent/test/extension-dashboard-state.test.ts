...
import { applyDisabledExtensionsToState } from "@zero2ai/coding-agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@zero2ai/coding-agent/modes/components/extensions/types";
