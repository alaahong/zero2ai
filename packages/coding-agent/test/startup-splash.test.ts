...
import { runStartupSplash } from "@zero2ai/coding-agent/modes/setup-wizard/startup-splash";
...
import { shouldShowStartupSplash } from "@zero2ai/coding-agent/startup-splash";
