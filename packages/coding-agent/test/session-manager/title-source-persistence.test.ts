...
import type { SessionTitleUpdate } from "@zero2ai/coding-agent/session/session-title-slot";
...
describe("session title source persistence", () => {
	...
	beforeEach(() => {
		testAgentDir = fs.mkdtempSync(path.join(os.tmpdir(), "zero2ai-title-source-"));
