...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule } from "@zero2ai/coding-agent/capability/rule";
import { bucketRules } from "@zero2ai/coding-agent/capability/rule-buckets";
