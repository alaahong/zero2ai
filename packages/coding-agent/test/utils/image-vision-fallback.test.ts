...
import type { Api, AssistantMessage, completeSimple, Model } from "@zero2ai/ai";
import type { ModelSpec } from "@zero2ai/ai/types";
import { buildModel } from "@zero2ai/catalog/build";
import { Settings } from "@zero2ai/coding-agent/config/settings";
import {
	type DescribeAttachedImagesDeps,
	describeAttachedImagesForTextModel,
} from "@zero2ai/coding-agent/utils/image-vision-fallback";
