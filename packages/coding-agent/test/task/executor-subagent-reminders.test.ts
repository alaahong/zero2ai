...
import { AgentBusyError, type AgentTelemetryConfig, type Tracer } from "@zero2ai/agent-core";
import { type AssistantMessage, Effort } from "@zero2ai/ai";
import { Settings } from "@zero2ai/coding-agent/config/settings";
import type { ExtensionActions, LoadExtensionsResult } from "@zero2ai/coding-agent/extensibility/extensions/types";
...
describe("runSubprocess yield reminders", () => {
	...
	const baseOptions = {
		...
		modelRegistry: {
			refresh: async () => {},
		} as unknown as import("@zero2ai/coding-agent/config/model-registry").ModelRegistry,
		enableLsp: false,
	};
