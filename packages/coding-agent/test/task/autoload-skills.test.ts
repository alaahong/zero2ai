...
import * as skillsModule from "@zero2ai/coding-agent/extensibility/skills";
...
function createSessionResult(session: AgentSession): CreateAgentSessionResult {
	return {
		session,
		extensionsResult:
			{} as unknown as import("@zero2ai/coding-agent/extensibility/extensions/types").LoadExtensionsResult,
		setToolUIContext: () => {},
