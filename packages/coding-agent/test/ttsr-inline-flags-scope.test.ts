...
import { compileRuleCondition } from "@zero2ai/coding-agent/capability/rule";
import { buildRuleFromMarkdown, createSourceMeta } from "@zero2ai/coding-agent/discovery/helpers";
