...
import { ArtifactProtocolHandler } from "@zero2ai/coding-agent/internal-urls/artifact-protocol";
...
import { resolveToolSearchScope } from "@zero2ai/coding-agent/tools/path-utils";
