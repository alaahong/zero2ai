...
import { ModelPickerComponent, type ModelPickerOptions } from "@zero2ai/coding-agent/modes/components/model-picker";
import { resolveSegmentPalette } from "@zero2ai/coding-agent/modes/components/segment-track";
