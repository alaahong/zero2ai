...
import { localeToKl, searchDuckDuckGo } from "@zero2ai/coding-agent/web/search/providers/duckduckgo";
import { parseSearchQuery } from "@zero2ai/coding-agent/web/search/query";
