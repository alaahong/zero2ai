...
import { renderSearchResult, type SearchRenderDetails } from "@zero2ai/coding-agent/web/search/render";
import type { SearchResponse } from "@zero2ai/coding-agent/web/search/types";
