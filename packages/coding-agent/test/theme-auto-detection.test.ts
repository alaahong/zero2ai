...
import * as nativesModule from "@zero2ai/natives";
import { type MacAppearanceObserver, MacOSAppearance } from "@zero2ai/natives";
import type { Terminal, TerminalAppearance } from "@zero2ai/tui";
