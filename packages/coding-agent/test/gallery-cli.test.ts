...
import {
	...
	resolveFixture,
} from "@zero2ai/coding-agent/cli/gallery-cli";
import {
	type GalleryFixture,
...
} from "@zero2ai/coding-agent/cli/gallery-fixtures";
import { resetSettingsForTest, Settings } from "@zero2ai/coding-agent/config/settings";
import { getComposerShapeOptions } from "@zero2ai/coding-agent/modes/components/composer-shape-registry";
import { ALL_SEGMENT_IDS } from "@zero2ai/coding-agent/modes/components/status-line/segments";
import { initTheme, theme } from "@zero2ai/coding-agent/modes/theme/theme";
import { toolRenderers } from "@zero2ai/coding-agent/tools/renderers";
