...
import CommitCommand from "@zero2ai/coding-agent/commands/commit";
import * as commitModule from "@zero2ai/coding-agent/commit";
import * as themeModule from "@zero2ai/coding-agent/modes/theme/theme";
import { postmortem } from "@zero2ai/utils";

describe("zero2ai commit command lifecycle (issue #1041)", () => {
	afterEach(() => {
		vi.restoreAllMocks();
	});
