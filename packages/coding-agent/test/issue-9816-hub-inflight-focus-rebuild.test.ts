...
import { SessionFocusController } from "@zero2ai/coding-agent/modes/controllers/session-focus-controller";
...
import type { AgentProgress, TaskToolDetails } from "@zero2ai/coding-agent/task/types";
