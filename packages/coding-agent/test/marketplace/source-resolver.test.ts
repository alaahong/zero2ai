...
import type { MarketplacePluginEntry } from "@zero2ai/coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource, validatePluginSource } from "@zero2ai/coding-agent/extensibility/plugins/marketplace";
...
describe("resolvePluginSource", () => {
	...
	beforeEach(() => {
		tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "zero2ai-src-res-test-"));
	});
