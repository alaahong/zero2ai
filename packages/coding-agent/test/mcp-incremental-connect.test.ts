...
import { applyMcpToggleRuntime } from "@zero2ai/coding-agent/modes/components/extensions/mcp-runtime";
...
describe("MCP incremental connectServers", () => {
	...
	beforeEach(() => {
		workDir = fs.mkdtempSync(path.join(os.tmpdir(), "zero2ai-mcp-incremental-"));
