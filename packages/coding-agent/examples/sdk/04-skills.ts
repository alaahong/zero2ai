 ...
 */
import { createAgentSession, discoverSkills, SessionManager, type Skill } from "@zero2ai/coding-agent";

// Discover all skills from cwd/.zero2ai/skills, ~/.zero2ai/agent/skills, etc.
