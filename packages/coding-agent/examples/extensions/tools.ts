 ...
 *
 * Usage:
 * 1. Copy this file to ~/.zero2ai/agent/extensions/ (legacy: ~/.pi/agent/extensions/) or your project's .zero2ai/extensions/
 * 2. Use /tools to open the tool selector
 */
import type { ExtensionAPI, ExtensionContext } from "@zero2ai/coding-agent";
import { getSettingsListTheme } from "@zero2ai/coding-agent";
import { Container, type SettingItem, SettingsList } from "@zero2ai/tui";
