	...
	eval: {
		...
		result: {
			content: [
				{
					type: "text",
					text: ["@zero2ai/coding-agent v0.42.0", "37 dependencies"].join("\n"),
				},
			],
			details: {
				language: "python",
				languages: ["python"],
				jsonOutputs: [["@ai-sdk/anthropic", "@zero2ai/ai", "@zero2ai/tui"]],
				cells: [
					{
						index: 0,
						title: "load config",
						...
						output: ["@zero2ai/coding-agent v0.42.0", "37 dependencies"].join("\n"),
						status: "complete",
						durationMs: 64,
						exitCode: 0,
					},
