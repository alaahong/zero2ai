...
import type * as MnemopiNs from "@zero2ai/mnemopi";
import type { Mnemopi, RecallResult } from "@zero2ai/mnemopi";
import type * as MnemopiCoreNs from "@zero2ai/mnemopi/core";
import type { LocalModelInitializer } from "@zero2ai/mnemopi/core";
import { logger, toError } from "@zero2ai/utils";
import {
	composeRecallQuery,
	formatCurrentTime,
...
/**
 * Lazily load `@zero2ai/mnemopi` (memoized) and route fastembed loads
