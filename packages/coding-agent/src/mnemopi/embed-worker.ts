 ...
 * `__zero2ai_worker_mnemopi_embed` selector). The whole point of this module is
...
import { defaultLocalModelInitializer, type StandardEmbeddingModel } from "@zero2ai/mnemopi/core";
