/**
 * `zero2ai __complete <kind> [-- <prefix>]` — dynamic completion candidates.
 *
 ...
 */
import { type GeneratedProvider, getBundledModels, getBundledProviders } from "@zero2ai/catalog/models";
import { Command } from "@zero2ai/utils/cli";
