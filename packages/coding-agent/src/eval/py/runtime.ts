...
import { $env, $which, getPythonEnvDir } from "@zero2ai/utils";
...
const DEFAULT_ENV_ALLOW_PREFIXES = ["LC_", "XDG_", "ZERO2AI_"];
 ...
 * the managed `~/.zero2ai/python-env`, then the system interpreter on PATH. Every
