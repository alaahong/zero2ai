...
import type { AgentTool, AgentToolResult, ToolTier } from "@zero2ai/agent-core";
...
export class SecurityScanTool implements AgentTool<typeof securityScanSchema, SecurityScanToolDetails> {
	...
	readonly summary = "Run ZERO2AI-native scans and explicit Codex Security cloud operations";
