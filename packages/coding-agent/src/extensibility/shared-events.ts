...
import type { CompactionPreparation, CompactionResult } from "@zero2ai/agent-core/compaction";
import type { AssistantRetryRecovery, ImageContent, TextContent, ToolResultMessage } from "@zero2ai/ai";
...
export interface SessionStopEventResult {
	...
	continue?: boolean;
	/** ZERO2AI-native model-visible context for the continuation */
