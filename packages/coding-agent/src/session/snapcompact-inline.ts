...
import type { Context, ImageContent, Model, TextContent, ToolResultMessage, UserMessage } from "@zero2ai/ai";
...
// Per-provider image-count budgets live in @zero2ai/snapcompact
...
/**
 * Minimal structural view of a history message — both zero2ai-ai `Message`s (the
