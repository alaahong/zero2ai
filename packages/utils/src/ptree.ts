...
import { Process } from "@zero2ai/natives";
...
const LINUX_SUBREAPER_COMMAND_ENV = "ZERO2AI_PTREE_SUBREAPER_COMMAND";
const LINUX_SUBREAPER_BUN_BE_BUN_ENV = "ZERO2AI_PTREE_SUBREAPER_BUN_BE_BUN";
