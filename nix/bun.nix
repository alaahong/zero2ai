...
}:
{
  ...
  "@zero2ai/browser-relay" = copyPathToStore ../packages/browser-relay;
  "@zero2ai/collab-web" = copyPathToStore ../packages/collab-web;
  "@zero2ai/stats" = copyPathToStore ../packages/stats;
  "@zero2ai/schema" = copyPathToStore ../packages/schema;
  "@zero2ai/agent-core" = copyPathToStore ../packages/agent;
  "@zero2ai/ai" = copyPathToStore ../packages/ai;
  "@zero2ai/catalog" = copyPathToStore ../packages/catalog;
  "@zero2ai/coding-agent" = copyPathToStore ../packages/coding-agent;
  "@zero2ai/metaharness" = copyPathToStore ../packages/metaharness;
  "@zero2ai/mnemopi" = copyPathToStore ../packages/mnemopi;
  "@zero2ai/natives" = copyPathToStore ../packages/natives;
  "@zero2ai/tui" = copyPathToStore ../packages/tui;
  "@zero2ai/utils" = copyPathToStore ../packages/utils;
  "@zero2ai/wire" = copyPathToStore ../packages/wire;
  "@zero2ai/snapcompact" = copyPathToStore ../packages/snapcompact;
  "@zero2ai/typescript-edit-benchmark" = copyPathToStore ../packages/typescript-edit-benchmark;
