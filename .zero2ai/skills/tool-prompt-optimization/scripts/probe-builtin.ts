 ...
 *
 * The heavy coding-agent import lives here; probe.ts stays zero2ai-ai-only.
 */
import { parseArgs } from "node:util";
import { toolWireSchema } from "@zero2ai/ai";
import { Settings } from "@zero2ai/coding-agent/config/settings";
import { BUILTIN_TOOLS, GithubTool, HIDDEN_TOOLS, IrcTool, type Tool, type ToolFactory, type ToolSession } from "@zero2ai/coding-agent/tools";
